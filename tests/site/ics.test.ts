...
const f: FixtureWithTeams = {
  ...
  home: { id: 1, fd_id: 86, slug: 'rm', name: 'Real Madrid CF', short_name: 'Real Madrid', tla: 'RMA', crest_url: null },
  away: { id: 2, fd_id: 81, slug: 'fcb', name: 'FC Barcelona', short_name: 'Barça', tla: 'FCB', crest_url: null },
};
