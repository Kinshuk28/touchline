...
describe('mergeLiveFixtures', () => {
  ...
  it('appends a fixture the page has not seen yet', () => {
    const kickedOff: FixtureWithTeams = {
      ...
      home: { id: 20, fd_id: 200, slug: 'c', name: 'C', short_name: 'C', tla: 'CCC', crest_url: null, club_colors: null, venue: null },
      away: { id: 21, fd_id: 201, slug: 'd', name: 'D', short_name: 'D', tla: 'DDD', crest_url: null, club_colors: null, venue: null },
    };
